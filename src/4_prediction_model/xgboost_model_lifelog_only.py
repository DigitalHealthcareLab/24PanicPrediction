...
shap.summary_plot(np.array(SHAP_values_per_fold), df.reindex(new_index), max_display = 10, show=False, color_bar=True, plot_size=(7.3, 6.5))
plt.savefig('data/model_results/'+ file_name + '/' + fig_name + save_time +'.png', dpi=300)
plt.close()